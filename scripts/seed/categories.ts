...
const tree: CategoryTree[] = [
  {
    id: 'cat-distilled', name: '蒸留酒', readonly: true, versionNo: 1, children: [
      {
        id: 'cat-whisky', name: 'ウイスキー', readonly: true, versionNo: 1, children: [
          {
            id: 'cat-scotch', name: 'スコッチウイスキー', readonly: true, versionNo: 1, children: [
      ...
      {
        ...CATEGORIES.ラム, readonly: true, versionNo: 1, children: [
          {
            ...CATEGORIES.ホワイトラム, readonly: true, versionNo: 1, children: [
          ...
          {
            ...CATEGORIES.ゴールドラム, readonly: true, versionNo: 1, children: [
          ...
          {
            ...CATEGORIES.ダークラム, readonly: true, versionNo: 1, children: [
          ...
          {
            ...CATEGORIES.アグリコールラム, readonly: true, versionNo: 1, children: [
