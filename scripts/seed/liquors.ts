...
const liquorData: LiquorInput[] = [
  ...
  // ラム - ホワイトラム（検索需要最高：モヒート・ダイキリ用途で人気）
  {
    categoryKey: 'ホワイトラム',
    name: 'バカルディ スペリオール',
    description: 'キューバ発祥のホワイトラム。軽やかでクリーンな味わいでモヒートやダイキリに最適。世界で最も売れているラムのひとつ。',
    versionNo: 1,
  },
  {
    categoryKey: 'ホワイトラム',
    name: 'ハバナクラブ 3年',
    description: 'キューバ産の定番ホワイトラム。サトウキビ由来の甘みとフレッシュな風味でモヒートに最適。',
    versionNo: 1,
  },
  {
    categoryKey: 'ホワイトラム',
    name: 'マウントゲイ シルバー',
    description: 'バルバドス産のホワイトラム。世界最古のラム蒸留所が造るクリーンで上品な味わい。',
    versionNo: 1,
  },
  {
    categoryKey: 'ホワイトラム',
  ...
  // ラム - ゴールドラム（万能：ストレート・カクテル両用で需要安定）
  {
    categoryKey: 'ゴールドラム',
    name: 'アプルトン エステート シグネチャーブレンド',
    description: 'ジャマイカ産のゴールドラム。ブレンダーマスターが手がけるフルーティーでスパイシーな定番品。',
    versionNo: 1,
  },
  {
    categoryKey: 'ゴールドラム',
    name: 'ハバナクラブ 7年',
    description: 'キューバ産の7年熟成ゴールドラム。まろやかな甘みとトバコ・バニラの複雑な香りが特徴。',
    versionNo: 1,
  },
  {
    categoryKey: 'ゴールドラム',
    name: 'バカルディ ゴールド',
    description: 'キューバ発祥のゴールドラム。バニラとアーモンドの香りで飲みやすいミディアムボディ。',
    versionNo: 1,
  },
  {
    categoryKey: 'ゴールドラム',
    name: 'マウントゲイ エクリプス',
    description: 'バルバドス産のゴールドラム。ブレンデッドスタイルでトロピカルフルーツと甘いバニラの香り。',
    versionNo: 1,
  },
  // ラム - ダークラム（熟成・複雑さ・プレミアム需要が高い）
  {
    categoryKey: 'ダークラム',
    name: 'マイヤーズ オリジナルダーク',
    description: 'ジャマイカ産の濃厚なダークラム。9種のラムをブレンドした複雑な風味でケーキやパンチに定番。',
    versionNo: 1,
  },
  {
    categoryKey: 'ダークラム',
    name: 'ゴスリング ブラックシール',
    description: 'バミューダ産のダークラム。コーラやジンジャービアとの相性が抜群で「ダークン・ストーミー」のベース。',
    versionNo: 1,
  },
  {
    categoryKey: 'ダークラム',
    name: 'ロン サカパ 23年',
    description: 'グアテマラ産のプレミアムダークラム。標高2,300mの涼しい気候で熟成。ソレラシステムで仕上げた濃厚な甘みと複雑さ。',
    versionNo: 1,
  },
  {
    categoryKey: 'ダークラム',
    name: 'アプルトン エステート 12年',
    description: 'ジャマイカン・ラムの頂点を代表する12年熟成品。オレンジピール・バナナ・オーク由来の豊かな香り。',
    versionNo: 1,
  },
  {
    categoryKey: 'ダークラム',
    name: 'ディプロマティコ レゼルバ エクスクルーシーバ',
    description: 'ベネズエラ産の最高峰ダークラム。12年熟成のポット&コラム蒸留ブレンド。ドライフルーツと甘いシェリーの風味。',
    versionNo: 1,
  },
  // ラム - スパイスドラム（カジュアル需要・コーラ割りで人気）
  {
    ...
    description: 'バニラ・シナモン・ナツメグなどのスパイスで風味付けしたジャマイカ産スパイスドラム。コーラ割りが定番。',
    versionNo: 1,
  },
  {
    categoryKey: 'スパイスドラム',
    name: 'セイラーズ ジェリー スパイスドラム',
    description: '米国ヴァージン諸島産のスパイスドラム。バニラ・シナモン・クローブを主体に17種のスパイスをブレンド。',
    versionNo: 1,
  },
  {
    categoryKey: 'スパイスドラム',
  ...
  // ラム - アグリコール > マルティニーク（AOC認定・マニア需要が高い）
  {
    categoryKey: 'マルティニーク',
  ...
  },
  {
    ...
    description: 'マルティニーク産の4年以上熟成アグリコールラム。アマレットとオーク由来のバランスの良い熟成香が特徴。',
    versionNo: 1,
  },
  {
    categoryKey: 'マルティニーク',
